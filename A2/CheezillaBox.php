...
<head>
    ...
    <body>
        <div id="wrapper">
            ...
            <div class="product">
                <h2 style="margin-left: 10px;">Cheezilla Box</h2><br>
                <table border="2">
                    <tr>
                        <td><img src="image/boxmeals1.webp" alt=""></td>
                        <td><p>RM 25.99
                            <br></br>
                            In your meal:
                            <ul>
                                <li><a>1 Zinger Cheezilla</a></li>
                                <li><a>1 Original Recipe Chicken</a></li>
                                <li><a>1 Crispier Fries (S) (Subject to availability)</a></li>
                                <li><a>1 Pepsi Black (Can)</a></li>
                            </ul></p></td>
                    </tr>
                </table>
            </div>
