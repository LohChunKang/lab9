<html lang="en">
    ...
    <body>
        <div id="wrapper">
            <div id="header">
                <div id="sidelogo">
                    <a><img src="image/logoKFC.png" alt=""></a>
                </div>
                <div id="subheader">
                ...
                <div id="heading">
                    ...
                    <!--product1-->
                    <div class="product">
                        <img src="image/chickenmeals.webp" alt="">
                        <div class="text">
                            <div class="feature">
                                <a href="3pcCombo.php"><p><u>3-pc Combo</u></p></a>
                    ...
                    <!--product2-->
                    <div class="product">
                        <img src="image/chickenmeals1.webp" alt="">
                        <div class="text">
                            <div class="feature">
                                <a href="2pcCombo.php"><p><u>2-pc Combo</u></p></a>
                                <input type="button" value="ADD TO ORDER">
                            </div>
                        </div>
                    </div>
                    <!--product3-->
                    <div class="product">
                        <img src="image/chickenmeals2.webp" alt="">
                        <div class="text">
                            <div class="feature">
                                <a><p><u>2-pc Nasi Lemak KFC Combo</u></p></a>
                                <input type="button" value="ADD TO ORDER">
                            </div>
                        </div>
                    </div>
                    <!--product4-->
                    <div class="product">
                        <img src="image/chickenmeals3.webp" alt="">
                        <div class="text">
                            <div class="feature">
                                <a><p><u>Zinger Fillet Nasi Lemak KFC Combo</u></p></a>
                                <input type="button" value="ADD TO ORDER">
                            </div>
                        </div>
                    </div>
                    <!--product5-->
                    <div class="product">
                        <img src="image/chickenmeals4.webp" alt="">
                        <div class="text">
                            <div class="feature">
                                <a><p><u>1-pc Nasi Lemak KFC Combo</u></p></a>
                                <input type="button" value="ADD TO ORDER">
                            </div>
                        </div>
                    </div>
