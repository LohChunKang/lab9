        ...
        <div id="wrapper">
            <div id="header">
                ...
                <div id="heading">
                    ...
                    <!--product1-->
                    <div class="product">
                        <img src="image/burgers.webp" alt="">
                        <div class="text">
                            <div class="feature">
                                <a href="BurgerP.Ramlee.php"><p><u>Burger P.Ramlee</u></p></a>
                    ...
                    <!--product2-->
                    <div class="product">
                        <img src="image/burgers1.webp" alt="">
                        <div class="text">
                            <div class="feature">
                                <a href="BurgerP.RamleeCombo.php"><p><u>Burger P.Ramlee Combo</u></p></a>
                                <input type="button" value="ADD TO ORDER">
                            </div>
                        </div>
                    </div>
                    <!--product3-->
                    <div class="product">
                        <img src="image/burgers2.webp" alt="">
                        <div class="text">
                            <div class="feature">
                                <a><p><u>Zero Chicken Burger Combo</u></p></a>
                                <input type="button" value="ADD TO ORDER">
                            </div>
                        </div>
                    </div>
                    <!--product4-->
                    <div class="product">
                        <img src="image/burgers3.webp" alt="">
                        <div class="text">
                            <div class="feature">
                                <a><p><u>Zinger Cheezilla Combo</u></p></a>
                                <input type="button" value="ADD TO ORDER">
                            </div>
                        </div>
                    </div>
                    <!--product5-->
                    <div class="product">
                        <img src="image/burgers4.webp" alt="">
                        <div class="text">
                            <div class="feature">
                                <a><p><u>Zinger Cheezy Combo</u></p></a>
                                <input type="button" value="ADD TO ORDER">
                            </div>
                        </div>
                    </div>
