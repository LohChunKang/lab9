        ...
        <div id="wrapper">
            <div id="header">
                ...
                <div id="heading">
                    ...
                    <!--product1-->
                    <div class="product">
                        <img src="image/drinks.webp" alt="">
                        <div class="text">
                            <div class="feature">
                                <a href="PepsiBlack.php"><p><u>Pepsi Black</u></p></a>
                    ...
                    <!--product2-->
                    <div class="product">
                        <img src="image/drinks1.webp" alt="">
                        <div class="text">
                            <div class="feature">
                                <a href="Pepsi.php"><p><u>Pepsi</u></p></a>
                                <input type="button" value="ADD TO ORDER">
                            </div>
                        </div>
                    </div>
                    <!--product3-->
                    <div class="product">
                        <img src="image/drinks2.webp" alt="">
                        <div class="text">
                            <div class="feature">
                                <a><p><u>Revive</u></p></a>
                                <input type="button" value="ADD TO ORDER">
                    ...
                    <!--product4-->
                    <div class="product">
                        <img src="image/drinks3.webp" alt="">
                        <div class="text">
                            <div class="feature">
                                <a><p><u>Lipton Ice Lemon Tea</u></p></a>
                                <input type="button" value="ADD TO ORDER">
                            </div>
                        </div>
                    </div>
                    <!--product5-->
                    <div class="product">
                        <img src="image/drinks4.webp" alt="">
                        <div class="text">
                            <div class="feature">
                                <a><p><u>Nescafe Original</u></p></a>
                                <input type="button" value="ADD TO ORDER">
                            </div>
                        </div>
                    </div>
