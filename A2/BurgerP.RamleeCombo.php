...
<head>
    ...
    <body>
        <div id="wrapper">
            ...
            <div class="product">
                <h2 style="margin-left: 10px;">Burger P.Ramlee Combo</h2><br>
                <table border="2">
                    <tr>
                        <td><img src="image/burgers1.webp" alt=""></td>
                        <td><p>RM 18.49
                            <br></br>
                            In your meal:
                            <ul>
                                <li><a>1 Burger P.Ramlee</a></li>
                                <li><a>1 Crispier Fries (R) (Subject to availability)</a></li>
